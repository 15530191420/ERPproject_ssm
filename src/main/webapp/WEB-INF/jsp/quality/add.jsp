		...
		<div class="layui-row">
			<form class="layui-form" method="post" action="add" id='form'>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_qualityTheme" name="qualityTheme"
							required="" lay-verify="qualityTheme" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_originalType" name="originalType"
							required="" lay-verify="originalType" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_currentUnits" name="currentUnits"
							required="" lay-verify="currentUnits" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_categ" name="categ" required=""
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_inspectionMethods" name="inspectionMethods" required=""
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="inspectionDept" lay-search>
							<c:choose>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_inspectionDate" name="inspectionDate"
							required="" lay-verify="inspectionDate" autocomplete="off"
							class="layui-input">
					</div>
				</div>
