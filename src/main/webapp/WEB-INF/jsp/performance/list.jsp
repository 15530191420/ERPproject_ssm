...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a href="">绩效改进</a>
			<a> <cite>绩效改进列表</cite></a>
				...
				<div class="layui-card">
					<div class="layui-card-body ">
						<form class="layui-form layui-col-space5" action="search" method="post">
							<div class="layui-inline layui-show-xs-block">
								<input type="text" name="progTheme" placeholder="请输入要查询的计划"
					...
					<div class="layui-card-header">
						<button class="layui-btn"
							onclick="xadmin.open('新建绩效改进计划','addInput',800,600)">
							<i class="layui-icon"></i>新建绩效改进计划
						</button>
					</div>
							...
							<tbody>
								<c:forEach items="${performances }" var="performance">
									<tr>
										...
										<td>${performance.progTheme }</td>
										<td>${performance.creater }</td>
										<td>${performance.createDate }</td>
										<td class="td-manage"><a title="编辑"
											onclick="xadmin.open('编辑','updateInput?id=${performance.id}',800,600)"
											href="javascript:;"> <i class="layui-icon">&#xe642;</i>
										</a> <a title="删除" onclick="member_del(this,${performance.id })"
											href="javascript:;"> <i class="layui-icon">&#xe640;</i>
										</a></td>
									</tr>
								</c:forEach>
