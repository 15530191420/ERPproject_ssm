			...
			<form class="layui-form" method="post" action="add" id='form'>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="applyname" lay-search lay-verify="applyname">
							<c:choose>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_applyDate" name="applyDate" required=""
							lay-verify="applyDate" autocomplete="off" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="currentDept" lay-search>
							<c:choose>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_currentPosition" name="currentPosition"
							required="" lay-verify="currentPosition" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_currentLevel" name="currentLevel"
							required="" lay-verify="currentLevel" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_hopeDate" name="hopeDate" class="layui-input" lay-verify="hopeDate">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="targetDept" lay-search lay-verify="targetDept">
							<c:choose>
								<c:when test="${empty depts }">
									<option value="0">暂无可选部门</option>
								</c:when>
								<c:otherwise>
									<option value="${dept.name}">请选择调至部门</option>
									<c:forEach items="${depts }" var="dept">
										<option value="${dept.name }">${dept.name }</option>
									</c:forEach>
								</c:otherwise>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_tatgetPosition" name="tatgetPosition"
							required="" lay-verify="tatgetPosition" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_targetLevel" name="targetLevel"
							required="" lay-verify="targetLevel" autocomplete="off"
							class="layui-input">
					</div>
				</div>
	...
	<script>
		...
		layui.use([ 'form', 'layer', 'jquery' ], function() {
			...
			form.verify({
				...
				hopeDate : function(value){
					if (value.length < 1) {
						return '希望日期不能为空';
					}
				},
				targetDept : function(value){
					if (value.length < 1) {
						return '调至部门不能为空';
					}
				},
				tatgetPosition : function(value){
					if (value.length < 1) {
						return '调至岗位不能为空';
					}
				},
				targetLevel : function(value){
					if (value.length < 1) {
						return '调至岗位职等不能为空';
					}
				},
