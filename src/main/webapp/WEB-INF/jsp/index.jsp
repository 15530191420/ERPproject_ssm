	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
				...
				<!-- 模块开始 -->
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="人事调用">&#xe6b8;</i> <cite>人事调用</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
						<!-- 一个li就是一个模块下的分支 -->
						<li><a onclick="xadmin.add_tab('调职申请列表','transfer/list')">
								<i class="iconfont">&#xe6a7;</i> <cite>调职申请单列表</cite>
						</a></li>
						<li><a onclick="xadmin.add_tab('离职申请列表','leave/list')"> <i
								class="iconfont">&#xe6a7;</i> <cite>离职申单请列表</cite>
						</a></li>
						<li><a onclick="xadmin.add_tab('调职通知单列表','transferNotice/list')"> <i
								class="iconfont">&#xe6a7;</i> <cite>调职通知单列表</cite>
						</a></li>
					</ul></li>
				<!-- 模块结束 -->
				...
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
					...
					<ul class="sub-menu">
						<!-- 一个li就是一个模块下的分支 -->
						<li><a onclick="xadmin.add_tab('工资报表列表','payment/list')"> <i
								class="iconfont">&#xe6a7;</i> <cite>工资报表列表</cite></a></li>
					</ul></li>
				<!-- 模块结束 -->
				...
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
					...
					<ul class="sub-menu">
						<!-- 一个li就是一个模块下的分支 -->
						<li><a onclick="xadmin.add_tab('自我鉴定列表','evaluation/list')"> <i
								class="iconfont">&#xe6a7;</i> <cite>自我鉴定列表</cite></a></li>
					</ul></li>
				<!-- 模块结束 -->
				
				<!-- 模块开始 -->
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="绩效改进">&#xe6b8;</i> <cite>绩效改进</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
						<!-- 一个li就是一个模块下的分支 -->
						<li><a onclick="xadmin.add_tab('绩效改进列表','performance/list')"> <i
				...
				<!-- 模块开始 -->
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="质检申请">&#xe6b8;</i> <cite>质检申请</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
						<!-- 一个li就是一个模块下的分支 -->
						<li><a onclick="xadmin.add_tab('质检申请列表','quality/list')"> <i
								class="iconfont">&#xe6a7;</i> <cite>质检申请列表</cite></a></li>
					</ul></li>
				<!-- 模块结束 -->
